            ...
            <nav className="px-16 py-5">
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-2">
                        <div onClick={navigateToLogin} className="px-4 py-2 cursor-pointer text-white bg-teal-500 rounded-3xl transform transition-transform duration-300 hover:scale-105">Login</div>
                        <div onClick={navigateToSignup} className="px-4 py-2 cursor-pointer text-white bg-teal-500 rounded-3xl transform transition-transform duration-300 hover:scale-105">Signup</div>
                    </div>
                </div>
            </nav>
